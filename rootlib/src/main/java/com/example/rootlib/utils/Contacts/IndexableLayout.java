...
import com.example.rootlib.utils.Contacts.database.DataObserver;
import com.example.rootlib.utils.Contacts.database.HeaderFooterDataObserver;
import com.example.rootlib.utils.Contacts.database.IndexBarDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    private int mBarTextColor, mBarFocusTextColor,mGravity;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBarHeight=a.getDimension(R.styleable.IndexableRecyclerView_indexBar_layout_height,getResources().getDimension(R.dimen.default_indexBar_layout_height));
            mGravity=a.getInteger(R.styleable.IndexableRecyclerView_indexBar_layout_gravity, Gravity.TOP);
            a.recycle();
        }
        ...
        params.gravity = mGravity | Gravity.RIGHT| Gravity.CENTER_VERTICAL;
