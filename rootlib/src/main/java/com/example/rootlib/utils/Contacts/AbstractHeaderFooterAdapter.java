...
import com.example.rootlib.utils.Contacts.database.HeaderFooterDataObservable;
import com.example.rootlib.utils.Contacts.database.HeaderFooterDataObserver;
import com.example.rootlib.utils.Contacts.database.IndexBarDataObservable;
...
abstract class AbstractHeaderFooterAdapter<T> {
    ...
    public AbstractHeaderFooterAdapter(String index, String indexTitle, List<T> datas) {
        ...
        if (indexTitle != null && datas != null && datas.size() != 0) {
