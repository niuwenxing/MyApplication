...
import com.example.rootlib.mvp.activity.BaseActivityASS;
...
public abstract class JiYingActivityASS<V extends IBaseView,P extends BasePresenter<V>> extends BaseActivityASS<V,P> {
