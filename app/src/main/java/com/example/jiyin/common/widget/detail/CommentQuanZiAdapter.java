...
public class CommentQuanZiAdapter extends BaseExpandableListAdapter {
    private static final String TAG = "CommentExpandAdapter";
    private List<UsercircleDetailBean.DataBean.DiscussBean> commentBeanList;
    private List<ReplyDetailBean> replyBeanList;
    private Context context;
    private int pageIndex = 1;
    private ItemIdClickListener itemClickListener;
    public CommentQuanZiAdapter(Context context, List<UsercircleDetailBean.DataBean.DiscussBean> commentBeanList) {
...
//        }
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        groupHolder.tv_time.setText(commentBeanList.get(groupPosition).getComment_time());
        groupHolder.comment_item_like_num.setText("");
//        groupHolder.iv_like.setSelected(commentBeanList.get(groupPosition).getUp()==1?true:false);
        groupHolder.iv_like.setVisibility(View.INVISIBLE);
...
//                childHolder.tv_content.setText(commentBeanList.get(groupPosition).getReplyList().get(childPosition).getContent());
     ...
     */
    public void addTheCommentData(UsercircleDetailBean.DataBean.DiscussBean commentDetailBean){
