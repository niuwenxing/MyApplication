...
public class StandardGSYNewVideoPlayer extends StandardGSYVideoPlayer{
    //亮度dialog
     ...
     */
    public StandardGSYNewVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public StandardGSYNewVideoPlayer(Context context) {
        super(context);
    }

    public StandardGSYNewVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, StandardGSYNewVideoPlayer.this);
        }
        prepareVideo();
    ...
    protected void showWifiDialog() {
        ...
        CommonNoticeDialog dialog = new CommonNoticeDialog(getActivityContext());
        dialog.setTitle("温馨提示");
        dialog.setMessage(getResources().getString(R.string.tips_not_wifi));
        dialog.setNegText(getResources().getString(R.string.tips_not_wifi_cancel));
        dialog.setPosiText(getResources().getString(R.string.tips_not_wifi_confirm));
...
//        builder.setNegativeButton(R.string.tips_not_wifi_confirm, new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//                dialog.dismiss();
//                startPlayLogic();
...
//        builder.create().show();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        StandardGSYNewVideoPlayer sf = (StandardGSYNewVideoPlayer) from;
        StandardGSYNewVideoPlayer st = (StandardGSYNewVideoPlayer) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            StandardGSYNewVideoPlayer gsyVideoPlayer = (StandardGSYNewVideoPlayer) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(StandardGSYNewVideoPlayer standardGSYVideoPlayer) {
