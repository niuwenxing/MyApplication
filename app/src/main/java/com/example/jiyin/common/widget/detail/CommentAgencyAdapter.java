...
public class CommentAgencyAdapter extends BaseExpandableListAdapter {
    private static final String TAG = "CommentExpandAdapter";
    private List<AgencyDetailBean.DataBean.StoriesBean> commentBeanList;
    private List<ReplyDetailBean> replyBeanList;
    private Context context;
    private int pageIndex = 1;
    private ItemIdClickListener itemClickListener;
    public CommentAgencyAdapter(Context context, List<AgencyDetailBean.DataBean.StoriesBean> commentBeanList) {
...
//                childHolder.tv_content.setText(commentBeanList.get(groupPosition).getReplyList().get(childPosition).getContent());
     ...
     */
    public void addTheCommentData(AgencyDetailBean.DataBean.StoriesBean commentDetailBean){
