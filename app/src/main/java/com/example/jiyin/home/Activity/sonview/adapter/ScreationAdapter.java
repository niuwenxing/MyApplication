...
public class ScreationAdapter extends BaseQuickAdapter<ZtimeIndexBean.DataBean.ScreationBean, BaseViewHolder> {
    public ScreationAdapter( @Nullable List<ZtimeIndexBean.DataBean.ScreationBean> data) {
